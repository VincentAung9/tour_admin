...
// import 'package:cached_network_image/cached_network_image.dart';import 'package:flutter_animate/flutter_animate.dart';
...
//   List<TourModel> _tours = []; // Changed to TourModel
//   List<TourModel> _filteredTours = []; // For search functionality
...
//           .where((tour) => tour.title!.toLowerCase().contains(query.toLowerCase()))
//           .toList();
//     });
//   }
//
//   void _navigateToEditScreen(TourModel tourData) { // Changed to TourModel
//     Navigator.push(
//       context,
//       MaterialPageRoute(
//         builder: (context) => TourEditScreen(tourData: tourData.toJson()), // Convert to Map
//       ),
//     ).then((_) {
