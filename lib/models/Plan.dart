...
class Plan {
  ...
  const Plan._internal({required name, required price}): _name = name, _price = price;
  
  factory Plan({required String name, required String price}) {
  ...
  Plan copyWith({String? name, String? price}) {
    return Plan._internal(
      name: name ?? this.name,
